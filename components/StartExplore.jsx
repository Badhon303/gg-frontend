...
const StartExplore = () => {
  return (
    <div className="relative py-24 lg:py-32">
      <div className=" absolute inset-y-0 w-screen xl:max-w-[1340px] 2xl:max-w-screen-2xl left-1/2 transform -translate-x-1/2 xl:rounded-[40px] z-0 bg-neutral-100/70"></div>
        ...
        <div>
          ...
          >
            <ul className="flex  p-1 bg-white  rounded-full shadow-lg overflow-x-auto hiddenScrollbar">
              <li className="relative" data-nc-id="NavItem2">
