      ...
      <main className="w-full lg:pb-28 lg:pt-20 ">
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-[30%] ">
            <div class="mt-4 p-4">
              <h1 class="mb-6 text-4xl font-semibold">Package status</h1>
              <div class="">
                <div class="flex flex-col text-gray-50">
                  <div class="flex">
                    <div class="relative col-start-2 col-end-4 mr-10 ">
                      <div class="flex h-full w-6 items-center justify-center">
                        <div class="pointer-events-none h-full w-1 bg-green-500"></div>
                      </div>
                      <div class="absolute top-1/2 -mt-9 -ml-7 h-20 w-20 rounded-full bg-green-500 text-center shadow">
                        <div className="absolute left-3 top-3">
                          <TbTruckDelivery className="w-14 h-14" />
                        </div>
                      </div>
                    </div>
                    <div class="col-start-5 col-end-12 my-4 mr-auto w-full rounded-xl bg-green-500 p-4 shadow-md">
                      <h3 class="mb-1 text-lg font-semibold">Package Booked</h3>
                      <p class="w-full text-justify leading-tight">
                  ...
                  <div class="flex">
                    <div class="relative col-start-2 col-end-4 mr-10">
                      ...
                      <div class="absolute top-1/2 -mt-3 h-6 w-6 rounded-full bg-green-500 text-center shadow">
                        <div className="absolute top-1 left-1">
                          <BsCheck2Circle />
                        </div>
                      </div>
                    </div>
                    <div class="col-start-4 col-end-12 my-4 mr-auto w-full rounded-xl bg-green-500 p-4 shadow-md">
                      <h3 class="mb-1 text-lg font-semibold">Package Booked</h3>
                      <p class="w-full text-justify leading-tight">
                        21 July 2021, 04:30 PM
                      </p>
                  ...
                  <div class="flex ">
                    ...
                    <div class="col-start-4 col-end-12 my-4 mr-auto w-full rounded-xl bg-red-500 p-4 shadow-md">
                  ...
                  <div class="flex ">
                    ...
                    <div class="col-start-4 col-end-12 my-4 mr-auto w-full rounded-xl bg-gray-300 p-4 shadow-md">
                      <h3 class="mb-1 text-lg font-semibold text-gray-400">
                        Delivered
                      </h3>
